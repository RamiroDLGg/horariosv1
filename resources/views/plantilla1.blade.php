...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a class="nav-link text-white" href="{{ route('alumnos.index') }}">Alumnos</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    @auth
      <p style="color: black">Usuario: {{Auth::user()->name}}</p>  
        <br>
        <p style="color: black">Correo: {{Auth::user()->email}}</p>
    @endauth
